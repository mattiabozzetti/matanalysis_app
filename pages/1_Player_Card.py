...
with left:
    st.markdown(
        ...
        <div class="hero-card hero-card-large">
          ...
          <div class="hero-context-line">Percentile vs {compare_role} · {reference_scope} · reference n = {len(reference_df)} · {mode} · team possession = {possession_txt} · style cluster = {cluster_id} · confidence = {cluster_conf_txt}</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
